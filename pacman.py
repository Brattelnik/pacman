...
class Lie:
    ...
    """
    name = 'default'
    lie_path = './resources/themes/' + name
    pacman = lie_path + '/pacman.png'
    pacman_right = lie_path + '/pacman_right.png'
    pacman_left = lie_path + '/pacman_left.png'
    pacman_down = lie_path + '/pacman_down.png'
    pacman_up = lie_path + '/pacman_up.png'
    ghost = lie_path + '/ghost.png'
    wall = lie_path + '/wall.png'
    dot = lie_path + '/Burger.png'
...
class Pacman(GameObject):
    ...
    """
    def __init__(self, x, y):
        GameObject.__init__(self, Lie.pacman, x, y)
        self.direction = 0
        self.velocity = 4.0 / 10.0
    ...
    def __set_direction(self, d):
        self.__direction = d
        if d == 1:
            self.image = pygame.image.load(Lie.pacman_right)
        elif d == 2:
            self.image = pygame.image.load(Lie.pacman_down)
        elif d == 3:
            self.image = pygame.image.load(Lie.pacman_left)
        elif d == 4:
            self.image = pygame.image.load(Lie.pacman_up)
        elif d != 0:
...
class Wall(GameObject):
    def __init__(self, x, y):
        GameObject.__init__(self, Lie.wall, x, y)


class Dot(GameObject):

    def __init__(self, x, y):
        GameObject.__init__(self, Lie.dot, x, y)
...
class Bonus(GameObject):
    ...
    def __init__(self, x, y):
        GameObject.__init__(self, Lie.bonus, x, y)
...
class EatBonus(GameObject):
    ...
    def __init__(self, x, y):
        GameObject.__init__(self, Lie.eat_bonus, x, y)
